                ...
                {(interaction, index, totalInteractions) => (
                  <>
                    ...
                    <ChatInteractions.Sources
                      ...
                      itemClassName='group inline-flex items-center bg-white border border-gray-200 rounded-lg px-3 py-2 hover:shadow-md hover:bg-gray-50 transition-all duration-200 cursor-pointer'
                    >
                    ...
                    {interaction.error && ( // use your custom error message component here
                      <div className='p-4 bg-red-100 dark:bg-red-700 rounded-lg max-w-80% mx-auto text-sm text-red-800'>
                        <p>Error: {interaction.error}</p>
                      </div>
                    )}
                    <ChatInteractions.AssistantMessage className='mb-2 p-4 bg-gray-100rounded-lg max-w-80% mx-auto text-sm'>
