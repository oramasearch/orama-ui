      ...
      <div className="max-w-7xl mx-auto">
        {/* <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Same Components,
            <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent"> Infinite Styles</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our headless components adapt to any design system. Here are just a few examples of what&apos;s possible.
          </p>
        </div> */}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <button className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg font-semibold hover:shadow-lg transition-all duration-300">
              View Code Example
            </button>
          </div>
    ...
    switch (theme) {
      case "modern":
        return {
          ...
          promptButton: "bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600",
          text: "text-gray-900",
          category: "bg-gray-50 hover:bg-gray-100 focus:bg-purple-100 focus:text-purple-800 focus:border-purple-200",
          ...
          resultItem: "bg-white hover:bg-purple-50 border-l-4 border-transparent hover:border-purple-300 hover:shadow-sm focus:border-purple-300 focus:shadow-sm focus:bg-purple-50",
          resultTitle: "text-gray-900 group-hover:text-purple-700 group-focus:text-purple-700",
          resultContent: "text-gray-600",
          chatActions: {
            resetButton: "px-3 py-1 bg-red-50 hover:bg-red-100 border border-red-200 rounded-lg text-sm text-red-700 transition-colors cursor-pointer",
            actionButton: "px-3 py-1 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-lg text-sm text-gray-700 transition-colors cursor-pointer",
            container: "flex space-x-2 my-3 justify-between"
          },
          noResults: {
            container: "bg-gray-50/50 rounded-lg p-6 text-center",
            iconContainer: "w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-3",
            icon: "w-6 h-6 text-gray-400",
            title: "text-lg font-medium text-gray-900",
            description: "text-sm text-gray-500",
            suggestionContainer: "w-10 h-10 rounded-full bg-purple-50 flex items-center justify-center mx-auto mb-2",
      ...
      case "dark":
        return {
          ...
          input: "bg-gray-800 border-gray-600 text-white focus:ring-cyan-400 focus:border-cyan-400",
          promptButton: "bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600",
          text: "text-white",
          category: "text-white bg-gray-800 hover:bg-gray-700 focus:bg-cyan-900 focus:text-cyan-200 focus:border-cyan-700",
          ...
          resultItem: "bg-gray-800 hover:bg-gray-700/80 border-l-4 border-transparent hover:border-cyan-400 hover:shadow-lg hover:shadow-cyan-500/10 focus:border-cyan-400 focus:shadow-lg focus:shadow-cyan-500/10",
          resultTitle: "text-gray-100 group-hover:text-cyan-300 group-focus:text-cyan-300",
          resultContent: "text-gray-400",
          chatActions: {
            resetButton: "px-3 py-1 bg-red-900/50 hover:bg-red-900/70 border border-red-700 rounded-lg text-sm text-red-300 transition-colors cursor-pointer",
            actionButton: "px-3 py-1 bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded-lg text-sm text-gray-300 transition-colors cursor-pointer",
            container: "flex space-x-2 my-3 justify-between"
          },
          noResults: {
            container: "bg-gray-800/50 rounded-lg p-6 text-center",
            iconContainer: "w-12 h-12 rounded-full bg-gray-800 flex items-center justify-center mx-auto mb-3",
            icon: "w-6 h-6 text-gray-500",
            title: "text-lg font-medium text-gray-100",
            description: "text-sm text-gray-400",
            suggestionContainer: "w-10 h-10 rounded-full bg-cyan-900/20 flex items-center justify-center mx-auto mb-2",
      ...
      case "playful":
        return {
          container: "bg-gradient-to-br from-yellow-100 to-pink-100 border-2 border-pink-300 rounded-3xl shadow-lg",
          input: "border-pink-300 focus:ring-pink-400 focus:border-pink-400 rounded-full",
          promptButton: "bg-gradient-to-r from-orange-400 to-pink-500 hover:from-orange-500 hover:to-pink-600 rounded-full",
          text: "text-gray-800",
          category: "bg-white/70 hover:bg-white/90 focus:bg-pink-200 focus:text-pink-800 focus:border-pink-300",
          ...
          resultItem: "bg-white/80 hover:bg-white rounded-2xl border-2 border-transparent hover:border-pink-200 hover:shadow-md transform hover:scale-102 focus:border-pink-200 focus:shadow-md transform focus:scale-102 transition-all mb-2",
          ...
          noResults: {
            ...
            iconContainer: "w-12 h-12 rounded-full bg-white/70 flex items-center justify-center mx-auto mb-3",
      ...
      default:
        return {
          ...
          resultsContainer: "bg-gray-50/50",
          groupHeader: "text-purple-600 border-b border-purple-100",
          resultItem: "bg-white hover:bg-purple-50 border-l-4 border-transparent hover:border-purple-300 hover:shadow-sm focus:border-purple-300 focus:shadow-sm",
          resultTitle: "text-gray-900 group-hover:text-purple-700 group-focus:text-purple-700",
          resultContent: "text-gray-600",
          chatActions: {
            resetButton: "px-3 py-1 bg-red-50 hover:bg-red-100 border border-red-200 rounded-lg text-sm text-red-700 transition-colors cursor-pointer",
  ...
  return (
    <SearchRoot client={collectionManager}>
      <ChatRoot client={collectionManager}>
        <section className={`p-6 transition-all duration-500 ${themeClasses.container}`} ref={ref} onKeyDown={(e: React.KeyboardEvent<HTMLElement>) => onKeyDown(e.nativeEvent)}>
          {!isChat ? (
            <div className="h-120 flex flex-col">
              <SearchInput.Wrapper className="relative mb-4 flex-shrink-0">
                <SearchInput.Input
                  type="text"
                  ...
                  {(
                    ...
                    <FacetTabs.Item
                      ...
                      className={cn(
                        ...
                        isSelected ? themeClasses.categorySelected : themeClasses.category,
                      )}
                    >
              ...
              <div className="flex-1 min-h-0 flex flex-col overflow-y-auto">
                <SearchResults.NoResults className={`flex flex-col items-center justify-center h-full ${themeClasses.noResults.container}`}>
                  {(searchTerm) => (
                    <>
                      {searchTerm ? (
                        <>
                        ...
                        <Suggestions.Wrapper className="flex flex-col justify-center gap-4">
                          <div className="flex flex-col items-center">
                            <div className={themeClasses.noResults.suggestionContainer}>
                              <Lightbulb className={themeClasses.noResults.suggestionIcon} />
                            </div>
                          ...
                          <Suggestions.List className="space-y-2 max-w-sm mx-auto">
                            ...
                            >
                              <span className={themeClasses.noResults.suggestionText}>
                                What is Orama?
                              </span>
                            </Suggestions.Item>
                            <Suggestions.Item
                ...
                >
                  {(group) => (
                    <div key={group.name} className="mb-6">
                      <h2 className={`text-sm uppercase font-bold tracking-wider pb-2 mb-4 ${themeClasses.groupHeader}`}>
                        {group.name}
                      </h2>
                        ...
                        {(hit) => (
                          ...
                          >
                            ...
                            {typeof hit.document?.title === "string" && (
                              <h3 className={`text-base font-semibold mb-2 transition-colors ${themeClasses.resultTitle}`}>
                                {hit.document?.title}
                              </h3>
                            )}
                            {typeof hit.document?.content === "string" && (
                              <p className={`text-sm line-clamp-2 transition-colors ${themeClasses.resultContent}`}>
              ...
              <div className="flex-1 min-h-0 flex flex-col">
                <ChatInteractions.Wrapper className="items-start relative overflow-y-auto">
                  {(interaction, index, totalInteractions) => (
                    <>
                      <ChatInteractions.UserPrompt className={`p-3 bg-purple-100 ${theme === 'dark' ? 'bg-purple-900' : ''} rounded-lg rounded-br-sm max-w-xs ml-auto`}>
                        ...
                        <div className={themeClasses.chatActions.container}>
                          <React.Fragment>
                            {index === totalInteractions && (
                              <div>
                                <ChatInteractions.Reset className={themeClasses.chatActions.resetButton}>
                                  Reset all
                            ...
                            {index === totalInteractions && (
                              <li>
                                <ChatInteractions.RegenerateLatest
                                  className={themeClasses.chatActions.actionButton}
                                >
