  ...
  return (
    <section className='relative min-h-screen flex items-center justify-center px-4 overflow-hidden'>
      ...
      <div className='relative z-10 text-center max-w-4xl mx-auto'>
        ...
        <h1 className='text-5xl md:text-7xl font-bold bg-gradient-to-r from-gray-900 via-purple-800 to-pink-800 bg-clip-text text-transparent mb-6 leading-none'>
          Build Beautiful <br />
        ...
        <p className='text-xl md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed'>
          Unstyled, composable React components with{' '}
          <span className='font-semibold text-purple-700'>built-in</span>{' '}
          support for AI chat, smart search, and more. Powered by Orama.
        </p>
