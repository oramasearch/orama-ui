    ...
    <div className='max-w-full mx-auto p-6'>
      ...
      >
        <div
          ...
          aria-label='Chat conversations'
        >
          <Tabs.List className='flex flex-col items-center w-full border-b border-gray-200'>
            <div className='flex items-center justify-between px-4 py-2 border-b border-gray-200 w-full'>
              ...
              <button
                onClick={addNewChat}
                className='ml-4 inline-flex items-center gap-1 p-2 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:bg-blue-600 focus:text-white rounded'
                aria-label='Add new chat'
                data-focus-on-arrow-nav
              >
                <PenBoxIcon className='w-4 h-4' />
            ...
            <div className='flex flex-row items-center space-x-1 w-full'>
              {itemsWithChat.map((chat) => (
                <div key={chat.id} className='flex items-center relative'>
                  <Tabs.Trigger
                    tabId={chat.id}
                    className={`px-4 py-2 text-sm font-medium whitespace-nowrap text-left focus:outline-none focus:text-gray-600 focus:border-blue-600 focus:border-b-4 ${
                      activeTab === chat.id
